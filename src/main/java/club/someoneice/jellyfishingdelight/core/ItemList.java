...
public final class ItemList {
    ...
    public static final RegistryObject<Item> LANTERN_PLANT_STICK = ITEMS.register("lantern_plant_stick",
            () -> simpleFood(10, 0.4f, Items.STICK.getDefaultInstance()));
    public static final RegistryObject<Item> CORAL_PLANT_STICK = ITEMS.register("coral_plant_stick",
            () -> simpleFood(10, 0.4f, Items.STICK.getDefaultInstance()));
    public static final RegistryObject<Item> TUBE_PLANT_STICK = ITEMS.register("tube_plant_stick",
            () -> simpleFood(10, 0.4f, Items.STICK.getDefaultInstance()));
    public static final RegistryObject<Item> CHOPED_SEANUT = ITEMS.register("choped_seanut",
            () -> simpleFood(2, 0.1f));
    public static final RegistryObject<Item> CHOPED_TUBE_PLANT = ITEMS.register("choped_tube_plant",
            () -> simpleFood(2, 0.1f));
    public static final RegistryObject<Item> CHOPED_LANTERN_PLANT = ITEMS.register("choped_lantern_plant",
            () -> simpleFood(2, 0.1f));

    public static final RegistryObject<Item> MINI_KRABBY_PATTY = ITEMS.register("mini_krabby_patty",
            () -> simpleFood(4, 0.4f, true, false));
    public static final RegistryObject<Item> JELLY_KRABBY_PATTY = ITEMS.register("jelly_krabby_patty",
            () -> simpleFood(14, 2.0f,
                    new MobEffectInstance(MobEffects.WATER_BREATHING, 20 * 60 * 6, 0)));
    public static final RegistryObject<Item> BLUE_JELLY_KRABBY_PATTY = ITEMS.register("blue_jelly_krabby_patty",
            () -> simpleFood(14, 2.0f,
                    new MobEffectInstance(MobEffects.WATER_BREATHING, 20 * 60 * 6, 0)));
    public static final RegistryObject<Item> BUBBLE_KRABBY_PATTY = ITEMS.register("bubble_krabby_patty",
            () -> simpleFood(6, 1.2f, false, true,
                    new MobEffectInstance(MobEffects.SLOW_FALLING, 20 * 60 * 6, 0),
                    new MobEffectInstance(MobEffects.WATER_BREATHING, 20 * 60 * 6, 0)));

    public static final RegistryObject<Item> RED_KRABBY_PATTY = ITEMS.register("red_krabby_patty",
            () -> simpleFood(4, 0.4f, true, true,
                    new MobEffectInstance(MobEffects.DAMAGE_BOOST, 20 * 30, 0)));
    public static final RegistryObject<Item> ORANGE_KRABBY_PATTY = ITEMS.register("orange_krabby_patty",
            () -> simpleFood(4, 0.4f, true, true,
                    new MobEffectInstance(MobEffects.FIRE_RESISTANCE, 20 * 30, 0)));
    public static final RegistryObject<Item> YELLOW_KRABBY_PATTY = ITEMS.register("yellow_krabby_patty",
            () -> simpleFood(4, 0.4f, true, true,
                    new MobEffectInstance(MobEffects.DIG_SPEED, 20 * 30, 0)));
    public static final RegistryObject<Item> GREEN_KRABBY_PATTY = ITEMS.register("green_krabby_patty",
            () -> simpleFood(4, 0.4f, true, true,
                    new MobEffectInstance(MobEffects.LUCK, 20 * 30, 0)));
    public static final RegistryObject<Item> BLUE_KRABBY_PATTY = ITEMS.register("blue_krabby_patty",
            () -> simpleFood(4, 0.4f, true, true,
                    new MobEffectInstance(MobEffects.NIGHT_VISION, 20 * 30, 0)));
    public static final RegistryObject<Item> PURPLE_KRABBY_PATTY = ITEMS.register("purple_krabby_patty",
            () -> simpleFood(4, 0.4f, true, true,
                    new MobEffectInstance(MobEffects.REGENERATION, 20 * 30, 0)));

    public static final RegistryObject<Item> RAW_KRABBY_PATTY_PATTY = ITEMS.register("raw_krabby_patty_patty",
            () -> simpleFood(1, 0.2f));
    ...
    public static final RegistryObject<Item> CHUM_BUCKET = ITEMS.register("chum_bucket",
    ...
    public static final RegistryObject<Item> CHUMSTICK = ITEMS.register("chumstick",
            () -> simpleFood(6, 0.4f,
    ...
    public static final RegistryObject<Item> CROAL_STEW = ITEMS.register("croal_stew",
    ...
    public static final RegistryObject<Item> ROCK_STEW = ITEMS.register("rock_stew",
            () -> simpleFood(12, 0.8f, Items.BOWL.getDefaultInstance(),
                    new MobEffectInstance(MobEffects.DARKNESS, 20 * 30, 0),
                    new MobEffectInstance(MobEffects.MOVEMENT_SLOWDOWN, 20 * 60 * 3, 0),
                    new MobEffectInstance(ModEffects.NOURISHMENT.get(), 20 * 60 * 5, 0)));

    public static final RegistryObject<Item> PINEAPPLE_STICK = ITEMS.register("pineapple_stick",
            () -> simpleFood(6, 0.3f, Items.STICK.getDefaultInstance()));
    public static final RegistryObject<Item> PINEAPPLE_SODA = ITEMS.register("pineapple_soda",
    ...
    public static final RegistryObject<Item> SEANUT_CHOCOLATE = ITEMS.register("seanut_chocolate",
            () -> simpleFood(8, 1.0f));
    ...
    public static final RegistryObject<Item> COLORFUL_KRABBY_PATTY = ITEMS.register("colorful_krabby_pattys",
            () -> new BlockItem(BlockList.COLORFUL_KRABBY_PATTYS.get(), new Item.Properties()));
    public static final RegistryObject<Item> GRILL = ITEMS.register("grill",
    ...
    private static Item simpleFood(int hunger, float saturation, boolean fast, boolean alwaysEat, boolean isDrink,
        ...
        return new Item(new Item.Properties().food(builder.build())) {
            ...
            public ItemStack finishUsingItem(final @NotNull ItemStack stack, final @NotNull Level level,
                ...
                if (!player.addItem(itemBowl)) {
                    level.addFreshEntity(new ItemEntity(level, player.getX(), player.getY(), player.getZ(), itemBowl));
                }
