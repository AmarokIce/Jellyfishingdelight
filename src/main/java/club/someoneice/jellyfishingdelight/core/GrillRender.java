...
public class GrillRender implements BlockEntityRenderer<GrillTile>, BlockEntityRendererProvider<GrillTile> {
    ...
    @Override
    public void render(GrillTile grillTile, float v, PoseStack poseStack, MultiBufferSource multiBufferSource, int i, int i1) {
